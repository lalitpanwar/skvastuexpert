          ...
          <Container>
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <p className="text-slate-600 text-base md:text-xl leading-relaxed max-w-3xl mx-auto">
                Consult Acharya Shivkumar Sharma for Home, Office, Plot, Factory
                & Commercial Vastu guidance with practical remedies and online
                floor plan analysis.
              </p>
            </div>
          </Container>
              ...
              <div className="bg-primary rounded-[2rem] p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/80 leading-relaxed mb-8">
                    Connect instantly on WhatsApp for fast consultation and
