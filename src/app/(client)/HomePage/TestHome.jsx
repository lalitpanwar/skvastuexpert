...
export default function TestHome() {
  return (
    <section className="relative bg-[#fffcf5] pt-28 md:pt-36 pb-10 overflow-hidden">
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left order-2 lg:order-1 mt-6 lg:mt-0">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight">
              Best <span className="text-primary italic font-serif">
                Vastu Consultant
              </span>{" "}
            ...
            <p className="text-slate-600 text-sm md:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed font-light px-4 md:px-0">
              Expert Vastu consultation for Home, Office, Plot, Shop,
              Factory & Commercial Spaces with practical remedies and
              online floor plan analysis.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 pt-2 px-4 md:px-0">
              ...
              <Link href="/online-vastu-analysis" className="w-full sm:w-auto">
                <CustomButton
